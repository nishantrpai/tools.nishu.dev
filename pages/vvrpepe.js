...
export default function Home() {
  ...
  const [punkImg, setPunkImg] = useState('/vvr.png')
  ...
  const scapeContract = '0x6339e5e072086621540d0362c4e3cea0d643e114'
  ...
  return (
    <>
      <Head>
        <title>vvrpepe</title>
        <meta name="description" content="vvrpepe" />
      ...
      <main>
        ...
        <div style={{ margin: 0, marginBottom: 20, display: 'flex', flexDirection: 'column', gap: 20, width: '50%' }}>
          ...
          <input type="text" value={scapeID} onChange={(e) => setScapesId(e.target.value)} placeholder='Enter Opepen ID' style={{
