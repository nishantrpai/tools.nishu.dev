  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Add thug life glasses on any image" />
      ...
      <main>
        ...
        <span style={{
          ...
          Add thug life glasses on any image
        </span>
        ...
        <button onClick={() => {
          ...
          a.href = dataURL
          a.download = `thuglife-${Date.now()}.png`
          a.click()
        }} style={{
          marginTop: 20
        }}>
