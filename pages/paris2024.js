...
export default function HigherHat() {
  ...
  const higherHat = '/paris2024patch.png'
  ...
  return (
    <>
      <Head>
        <title>
          Olympic Paris 2024 eye patch
        </title>
        <meta name="description" content="Add olmypic paris 2024 eye patch on any image" />
      ...
      <main>
        ...
        <span style={{
          ...
          Add olympic paris 2024 eye patch on any image
        </span>
        ...
        <canvas id="canvas" width="2000" height="2000" style={{
        ...
        <button onClick={() => {
          ...
          a.href = dataURL
          a.download = `olympics2024-${Date.now()}.png`
          a.click()
        }} style={{
          marginTop: 20
        }}>
