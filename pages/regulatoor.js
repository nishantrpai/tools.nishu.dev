...
export default function HigherHat() {
  ...
  const higherHat = '/regulatoor.svg'
  ...
  return (
    <>
      <Head>
        <title>Regulatoor</title>
        <meta name="description" content="Add regulatoor on any image" />
      ...
      <main>
        ...
        <button onClick={() => {
          ...
          a.href = dataURL
          a.download = `regulatoor-${Date.now()}.png`
          a.click()
        }} style={{
          marginTop: 20
        }}>
