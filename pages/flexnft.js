...
const NFTCompare = () => {
  ...
  return (
    ...
    <main className={styles.main}>
      ...
      <div style={{ display: 'flex', width: '100%', gap: '10px', alignContent: 'center', justifyContent: 'center', marginTop: 100, height: 900, width: '100%', cursor: 'none !important', width: '800px' }}>
