...
export default function HigherHat() {
  ...
  const higherHat = '/higherglasses.png'
  ...
  return (
    <>
      <Head>
        <title>Higher Glasses</title>
        <meta name="description" content="Higher Glasses" />
      ...
      <main>
        ...
        <span style={{
          ...
          Add higher glasses on any image
        </span>
        ...
        <button onClick={() => {
          ...
          a.href = dataURL
          a.download = `higherglasses-${Date.now()}.png`
          a.click()
        }} style={{
          marginTop: 20
        }}>
