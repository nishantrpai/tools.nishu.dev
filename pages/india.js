...
export default function America() {
  ...
  useEffect(() => {
    // when set blend 
    blendUpdateCanvas(INDIA_FLAG, img)
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Merge Indian Flag on any NFT or image" />
      ...
      <main>
        ...
        <p className={styles.description}>
          Add Indian Flag to any NFT or image
        </p>
