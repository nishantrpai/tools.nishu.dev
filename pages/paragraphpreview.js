...
export default function MirrorPreview() {
    ...
    return new Promise((resolve, reject) => {
      fetch(`https://api.codetabs.com/v1/proxy/?quest=${link}`)
        ...
        .then(data => {
          ...
          let favicon = "https://paragraph.xyz/android-chrome-512x512.png";
  ...
  return (
    <>
      <Head>
        <title>Paragraph preview</title>
        <meta name="description" content="Create preview from your paragraphxyz for your socials" />
      ...
      <main>
        ...
        <p className={styles.description}>
          Create preview from your paragraph post for your socials
        </p>
